...
namespace WP8Nico.nomula
{
    public partial class App : Application
    {
        ...
        public static readonly string watchUrl = "http://www.nicovideo.jp/watch/{0}";
        public static Stack<object> pageState = new Stack<object>();
        ...
        private void InitializePhoneApplication()
        {
            ...
            RootFrame.UriMapper = new WP8NicoURIMapper();
